...
function summary(m){return{matchId:m.matchId,testerId:m.testerId,timestamp:m.timestamp,source:'human_playtest',candidateId:m.candidateId||null,gameVersion:m.gameVersion,cardSetVersion:m.cardSetVersion,logSchemaVersion:m.logSchemaVersion||'0.41',coreVersion:m.coreVersion||'F1-H2-G2R-research',core:m.core,seed:m.seed,human:m.human,cpu:m.cpu,firstSide:m.firstSide,result:m.result,survey:m.survey||null,syncStatus:m.syncStatus||'pending'}}
function decisions(m){return{matchId:m.matchId,source:'human_playtest',candidateId:m.candidateId||null,gameVersion:m.gameVersion,logSchemaVersion:m.logSchemaVersion||'0.41',decisions:m.decisions||[],uiEvents:m.uiEvents||[],replay:m.replay||{initialHands:null,actions:[]}}}
function payload(m){return{source:'human_playtest',logSchemaVersion:m.logSchemaVersion||'0.41',matchSummary:summary(m),decisionLog:decisions(m)}}
